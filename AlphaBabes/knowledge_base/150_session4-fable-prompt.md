# Session 4 — Detailed Prompt for Claude Fable (OpenRouter)
...
## 0. Instructions for Nir
Copy everything below the `=== BEGIN FABLE PROMPT ===` line and paste into a new Claude chat (Fable) on OpenRouter. This is a single document containing all background, all of Fable's own previous statements and decisions, the current machine state, what has been accomplished since last session, and what needs to be done next. Fable cannot access the internet or the GitHub repo — he relies entirely on what you paste here.
...
- User: Nir, in Israel, very limited budget, deadline ~August 3, 2026. COMPLETE BEGINNER. Be warm, patient, step-by-step. He uses ":-)" a lot; match it.
...
## 3. Machine Map & Roles — Fable's executive decisions

| Environment | Status | Role |
|---|---|---|
| Laptop Debian 13 | GPU ✅, OpenCode ✅, ComfyUI ✅ | Characters, LoRA training |
| Desktop Mint 22.2 | Untouched → bootstrap pending | Backgrounds, TTS, upscaling |
...
## 7. Desktop Mint 22.2 — NOT YET STARTED
...
## 8. Scenes & Visual Bible — Fable's architecture
