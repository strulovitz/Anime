# Alpha Babes — Full Narration Text for Subtitles
**Purpose:** Nir decided he now wants subtitles for Madie's gift after all (and possibly dubbing into Romanian via ElevenLabs). This document collects just the spoken narration text with voice-direction cues (e.g. [softly], [serious]) for every scene/segment, in order — no LEFT/RIGHT layout info, no emotion-image labels, just the words that get spoken. Content is appended here exactly as Nir pastes it in from his saved Claude Fable conversation history, one scene at a time.

## 🎬 SCENE 1 — The Alpha in the Void

[softly] This is the Alpha. She left Earth twelve centuries ago... not the fastest ship ever dreamed — but the wisest.

Six copper submarines ride around one hollow heart, wrapped in a blanket of ice against the killing rays of deep space. Her great dish drinks hydrogen from the void itself.

[serious] She cannot stop... and she cannot turn back.

[warmly] And inside her... ten sleeping women carry everything humanity ever was.
...
The Titanites came heaviest of all. For the first time in eight hundred years, their Great Works stood silent — and the girders of their unfinished monuments had been re-forged into dreadnought armor and fleets of mirror drones. [softly] And on every hull, where a clan would carve its own name and its own glory... every clan had engraved the same single line — the first shared inscription in their history: [moved] "Carried together."
