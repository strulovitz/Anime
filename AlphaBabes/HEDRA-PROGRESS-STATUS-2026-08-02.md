...
Total Hedra clips made so far: 80 (across scenes 1-16, all complete)

## WHAT'S LEFT TO DO:
1. Do Scenes 17 through 27 the same way, segment by segment (segment counts vary per scene, typically 4-5, always confirmed by Nir).
