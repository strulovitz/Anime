...
Total Hedra clips made so far: 46 (across scenes 1-10, ALL COMPLETE)

## WHAT'S LEFT TO DO:
1. Do Scene 11 (Taming the Dragon, corrected physics) then Scenes 12 through 27 the same way, segment by segment (segment counts vary per scene, typically 4-5, always confirmed by Nir).
