...
Total Hedra clips made so far: 41 (across scenes 1-8, ALL COMPLETE)

## WHAT'S LEFT TO DO:
1. Do Scenes 9 through 27 the same way, segment by segment (segment counts vary per scene, typically 4-5, always confirmed by Nir).
