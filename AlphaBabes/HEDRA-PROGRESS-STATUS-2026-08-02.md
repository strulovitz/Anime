...
Total Hedra clips made so far: 90 (across scenes 1-17, all complete)

## WHAT'S LEFT TO DO:
1. Do Scenes 18 through 27 the same way, segment by segment (segment counts vary per scene, typically 4-5, always confirmed by Nir).
