...
THE MAGAZINE: behind the cradle, the storage rack — a heavy honeycomb lattice of steel tubes holding dozens of identical rods nose-outward in tidy rows, each secured by a quick-release clamp, each tube mouth stenciled with its rod's number. Yellow-and-black caution striping frames the rack. Above, a compact loading gantry with a chain hoist and grapple (the rods are far too heavy for human hands) waits on its overhead rail. Copper-riveted walls, deck tie-downs, hard practical work-lighting from caged lamps throwing honest shadows.

MOOD: quiet menace through understatement — a room of sleeping metal bars, each one a city-killer by arithmetic alone. The horror is that there is nothing to see: just mass, waiting.

FORBIDDEN: no glowing tips, no circuitry, no rocket nozzles on the rods, no explosions or action — stillness, machining marks, and weight.